...
SITES=/home/jbos/Moz_scripts/common_sites.txt

CONTIG=$(sed -n "${SLURM_ARRAY_TASK_ID}p" ${CONTIG_LIST})

BAMLIST_CALDEIRA=/home/jbos/Moz_reads/bam_names_caldeira.txt
OUTDIR_CALDEIRA=/scratch/jbos/Moz_aligned_mil/beagle_contigs_caldeira2

mkdir -p $OUTDIR_CALDEIRA
...
OUTDIR_PEMBA1=/scratch/jbos/Moz_aligned_mil/beagle_contigs_pemba_broad2

mkdir -p $OUTDIR_PEMBA1
...
OUTDIR_PEMBA2=/scratch/jbos/Moz_aligned_mil/saf_contigs_pemba_narrow2
...
OUTDIR_WIMBE=/scratch/jbos/Moz_aligned_mil/saf_contigs_wimbe2
...
OUTDIR_PENINSULA=/scratch/jbos/Moz_aligned_mil/saf_contigs_peninsula2
